...
use App\Http\Controllers\NilaigloriaController;
...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::get('nilai', [NilaigloriaController::class, 'index'])->name('nilai.index');
    Route::get('cetak_nilai', [NilaigloriaController::class, 'cetak_nilai'])->name('cetak_nilai');
